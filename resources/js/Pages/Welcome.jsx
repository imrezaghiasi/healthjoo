      ...
      items-center min-h-screen">
                    ...
                    <div className="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
                        <div className="md:w-1/2 md:px-4 lg:w-1/4 ">
                            <div
                                ...
                                <a href="#"
                                   className="block mt-4 border-1 px-4 py-2 border-gray-300 border-2 rounded-md hover:translate-y-1 hover:scale-100 hover:duration-1000 hover:bg-gray-200">بیشتر
                                    ...</a>
                            </div>
                        </div>
                ...
                <section
                    ...
                    <div className="md:flex md:items-center md:justify-center">
                        ...
                        <a href="#"
                           className="px-8 py-4 bg-white text-blue-600 rounded inline-block font-semibold md:mr-8 mt-4 md:mt-0 hover:scale-105 hover:duration-1000 hover:bg-gray-200">رزرو نوبت</a>
                    </div>
                </section>
                <footer
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                            ...
                            <ul className="mt-4">
                                <li className="mt-2"><a href="#" title="" className="opacity-75 hover:opacity-100">عمومی</a></li>
                                <li className="mt-2"><a href="#" title="" className="opacity-75 hover:opacity-100">داخلی</a></li>
                                <li className="mt-2"><a href="#" title="" className="opacity-75 hover:opacity-100">اطفال</a></li>
                            </ul>
                        </div>
