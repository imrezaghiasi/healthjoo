                            ...
                            <table className="w-full dark:bg-gray-800 table-auto text-xs">
                                ...
                                {appointments.data.map(({
                                    ...
                                    <tr key={id} className="text-center border dark:border-gray-700 dark:text-gray-300">
                                        ...
                                        <td className="px-4 py-2">{clinic.doctor.first_name + ' ' + clinic.doctor.last_name}</td>
                                        <td className="px-4 py-2">{
                                            ...
                                            is_expired === 1
                                                &&
                                                (<span
                                                        className="bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">منقضی شده</span>
                                                )
