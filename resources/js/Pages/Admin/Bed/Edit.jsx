...
const Edit = ({auth, errors}) => {
    ...
    const {bed,rooms, departments} = usePage().props
    ...
    function handleSubmit(e) {
        e.preventDefault();
        router.post(route("admin.beds.update", bed.id), data);
    }
    ...
    return (
        <Authenticated
            auth={auth}
            errors={errors}
            header={<h2 className="font-semibold text-xl leading-tight">ویرایش تخت</h2>}
        >
