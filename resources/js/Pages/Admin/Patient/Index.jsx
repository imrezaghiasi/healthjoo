...
export default function Index(props) {
    ...
    function destroy(e) {
        if (confirm("آیا از حذف این مورد مطمئن هستید؟")) {
            router.delete(route("admin.patients.destroy", e.currentTarget.id));
        }
    }
    ...
    return (
        <Authenticated
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl leading-tight">بیماران</h2>}
        >
                        ...
                        <div className="p-3 bg-white dark:bg-gray-800 dark:shadow-xl">
                            ...
                            <table className="w-full dark:bg-gray-800 table-auto text-xs">
                                ...
                                <tr className="bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                                    ...
                                    <th className="px-4 py-2">گروه خونی</th>
                                    <th className="px-4 py-2">آدرس</th>
                                    <th className="px-4 py-2">عملیات</th>
                                </tr>
                                </thead>
                                <tbody>
                                {patients.data.map(({ id, first_name,last_name,gender,national_code,mobile,blood_group,photo_path,address,deleted_at }) => (
                            ...
                            <Pagination links={patients.links} class="mt-5"/>
                        </div>
                    </div>
                </div>
            </div>
