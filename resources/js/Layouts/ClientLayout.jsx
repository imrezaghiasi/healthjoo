                    ...
                    <header className="px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
                                ...
                                <li>
                                    <div className="flex items-center">
                                        <svg
                                            ...
                                            className="w-6 h-6 fill-current dark:text-white text-black"
                                            viewBox="0 0 24 24"
                                        >
                        ...
                        <div className="flex flex-wrap items-center justify-between py-6">
                            <div className="w-1/2 md:w-auto">
                                <Link
                                    href={route("welcome")}
                                    className="text-gray-700 dark:text-gray-200 font-bold text-2xl"
                                >
                                    بیمارستان سلامت
                                </Link>
                            </div>
                                ...
                                <form className="flex items-center mt-6">
                                    <div className="w-full">
                                        ...
                                        <div className="relative">
                                            ...
                                            <button
                                                type="submit"
                                                className="bg-teal-500 hover:bg-teal-400 text-white px-4 py-2 text-sm font-bold rounded absolute top-0 left-0 my-2 ml-2"
                                            >
                                                Subscribe
                                            </button>
                                        </div>
