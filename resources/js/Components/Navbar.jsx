...
const Navbar = () => {
    const {openSidebar,user,showingNavigationDropdown,setShowingNavigationDropdown} = useContext(Context);
    return (
        <div>
            <nav
                        ...
                        <div className="flex items-center justify-center">
                            <Link href={route('welcome')} className="flex ml-2 md:mr-24">
                                <svg className="mb-3" fill="#08781e" version="1.1" id="Capa_1"
                                     ...
                                     viewBox="0 0 441.344 441.343" xmlSpace="preserve"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600 bg-gray-200 dark:bg-gray-700">
                        <div className="px-4">
                            <div
