            ...
            text-center bg-gradient-to-b from-gray-100 to-gray-200 text-xl dark:bg-gradient-to-b dark:from-gray-800 dark:to-gray-900">
                ...
                <div className="hidden text-right text-sm font-thin mt-2 w-4/5 mx-auto dark:text-gray-200" id="submenu">
                    <Link
                        ...
                        className="text-[14px] dark:text-gray-200 p-1 mb-2 flex items-center rounded-md px-4 duration-300 cursor-pointer bg-gray-300 hover:bg-green-400 dark:hover:bg-green-600 dark:text-white">
                        <i className="bi bi-heart-pulse-fill ml-4"></i>
                        <p>نوبت ها - بیماری</p>
                    </Link>
                    <Link
                        href={route('admin.reports.requestAppointmentsAccordingGender')}
                        className="text-[14px] dark:text-gray-200 p-1 flex items-center rounded-md px-4 duration-300 cursor-pointer bg-gray-300 hover:bg-green-400 dark:hover:bg-green-600 dark:text-white">
                        <i className="bi bi-heart-pulse-fill ml-4"></i>
                        <p>نوبت ها - جنسیت</p>
                    </Link>
                </div>
